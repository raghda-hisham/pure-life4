    ...
    <form v-on:submit.prevent="submitForm">
      <div class="inputs form-group">
        <div class="personal-data data">
          ...
          <div>
            <label for="phone" class="required">رقم التليفون </label>
            <input
              type="text"
              placeholder="010.."
              id="phone"
          ...
          <div>
            <label for="id" class="required">رقم البطاقة</label>
            <input
              type="text"
              placeholder=""
              id="id"
        ...
        <div class="job-data data">
          ...
          <div>
            <label for="position" class="required">الوظيفة</label>
            <select name="position" v-model="form.position_id">
              <option value="select-one">--select-one--</option>
          ...
          <!--./الراتب-->
          <div>
            <label for="visa_num" class="required">رقم فيزا </label>
            <input
              type="text"
              placeholder=".."
              id="visa_num"
              name="visa_num"
              required
              v-model="form.visa_num"
            />
          </div>
          <!--./رقم فيزا-->
          <div>
            <label for="work_hours" class="required">ساعات العمل</label>
            <select name="work_hours" v-model="form.work_hours">
              <option value="select-one">--select-one--</option>
          ...
          <!--./ساعات العمل-->
          <div>
            <label for="shift" class="required">الوردية</label>
            <select name="shift" v-model="form.shift">
              <option value="select-one">--select-one--</option>
          ...
          <div>
            ...
            <select name="department" v-model="form.department_id">
              <option value="select-one">--select-one--</option>
          ...
          <!--./الموقع-->
          <div>
            <label for="papers" class="required">الاوراق </label>
            <input
              type="text"
              id="papers"
              name="papers"
          ...
          <!--الاوراق-->
          <div>
            <label for="paper_completed" class="required"
              >تاريخ اكتمال الأوراق</label
            >
            <input
              type="date"
              id="paper_completed"
...
export default {
  ...
  methods: {
    ...
    employeePost() {
      axios
        .post("http://127.0.0.1:8000/api/storeemployee", this.form)
        .then(() => {
          this.$emit("post");
          this.$emit("submitBtn");
        })
